...
namespace SparseSurfelFusion {
	...
	private:
		 ...
		 */
		void BoundBoxVisualization(const pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, DeviceArrayView<OrientedPoint3D<float>> points, Point3D<float> MaxPoint, Point3D<float> MinPoint);
		 ...
		 * \param points 有向点
		 */
		void CheckOctreeDividedArea(const pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, DeviceArrayView<OrientedPoint3D<float>> points);
