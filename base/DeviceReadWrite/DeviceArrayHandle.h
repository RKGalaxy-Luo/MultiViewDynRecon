 ...
 *         
 *    //hsg DeviceArrayHandle代替了DeviceArraySlice
 * 
 * \author LUO
...
namespace SparseSurfelFusion {
	...
	public:
		...
		//修改指针指向的地址
		//__host__ __device__ __forceinline__ void changePtrandSize(T* dev_arr, size_t size) {
		//	deviceArray = dev_arr;
		//	deviceArraySize = size;
		//}
	...
	public:
		...
		//修改地址与大小。
		//__host__ __forceinline__ void changePtrandSize(T* buffer, size_t capacity) {
		//	Buffer.changePtrandSize(buffer, capacity);
		//	Array.changePtrandSize(buffer, capacity);
		//}
