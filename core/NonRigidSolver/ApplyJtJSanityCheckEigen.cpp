...
void SparseSurfelFusion::ApplyJtJHandlerMatrixFree::appendScalarCostJacobianTriplet(
...
void SparseSurfelFusion::ApplyJtJHandlerMatrixFree::appendSmoothJacobianTriplet(std::vector<Eigen::Triplet<float>>& jacobian_triplet) {
...
void SparseSurfelFusion::ApplyJtJHandlerMatrixFree::appendFeatureJacobianTriplet(
	unsigned row_offset,
	std::vector<Eigen::Triplet<float>>& jacobian_triplet
) {
	//Download the required data
...
void SparseSurfelFusion::ApplyJtJHandlerMatrixFree::applyJtJEigen(
	...
	FUNCTION_CHECK_EQ(num_nodes * 6, x.size());
	FUNCTION_CHECK_EQ(num_nodes * 6, jtj_x.size());
