...
namespace SparseSurfelFusion {
	...
	public:
		...
		DEFAULT_CONSTRUCT_DESTRUCT(PreconditionerRhsBuilder);
		NO_COPY_ASSIGN(PreconditionerRhsBuilder);
	...
	private:
		...
		void updateCrossViewJtJDiagonalHost(std::vector<float>& jtj_flatten);
	...
	public:
		...
		/* The buffer and method to inverse the preconditioner  该缓冲器和反转预调节器的方法
		 */
	private:
	...
	private:
		...
		void updateCrossViewJtResidualHost(std::vector<float>& jt_residual);
