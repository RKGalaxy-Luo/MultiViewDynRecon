...
void SparseSurfelFusion::BlockPCG6x6::AllocateBuffer(const unsigned max_maxtrix_size)
{
...
void SparseSurfelFusion::BlockPCG6x6::ReleaseBuffer()
{
...
bool SparseSurfelFusion::BlockPCG6x6::SetSolverInput(
...
SparseSurfelFusion::DeviceArray<float> SparseSurfelFusion::BlockPCG6x6::Solve(
	const int max_iters,
	cudaStream_t stream
) {
...
SparseSurfelFusion::DeviceArray<float> SparseSurfelFusion::BlockPCG6x6::SolveTextured(const int max_iters, cudaStream_t stream)
{
	//Correct the size for output
	DeviceArray<float> valid_x;
