...
void SparseSurfelFusion::ApplyJtJHandlerMatrixFree::ApplyJtJAtomic(
	...
	FUNCTION_CHECK_EQ(x.Size(), device::jtj_dot_blk_size * num_nodes);
	FUNCTION_CHECK_EQ(jtj_dot_x.Size(), device::jtj_dot_blk_size * num_nodes);
