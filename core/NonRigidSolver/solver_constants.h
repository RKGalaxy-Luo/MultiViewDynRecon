...
#define d_distance_max 0.025f * 0.025f	// 2.5cm

#define d_live_observed_normal_cos_threshold 0.8f

#define MAX_NONRIGID_CUDA_STREAM 5		// 非刚性求解cuda流数量

#define USE_NEAREST_DISTANCE_PAIRS
...
#define d_correspondence_distance_threshold 0.075f
