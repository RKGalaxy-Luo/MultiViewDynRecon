...
void SparseSurfelFusion::ApplyJtJHandlerMatrixFree::updateScalarJtJDotXDirect(
	const std::vector<float>& x,
	SparseSurfelFusion::ScalarCostTerm2Jacobian& term2jacobian,
...
void SparseSurfelFusion::ApplyJtJHandlerMatrixFree::updateSmoothJtJDotXDirect(const std::vector<float>& x, std::vector<float>& jtj_x) {
	//Download the required data
...
void SparseSurfelFusion::ApplyJtJHandlerMatrixFree::updateFeatureJtJDotXDirect(
	const std::vector<float>& x,
	std::vector<float>& jtj_x
) {
	//Download the required data
